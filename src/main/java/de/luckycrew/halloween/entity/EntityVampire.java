		...
		public void updateTask() {
			...
			if (entitylivingbase.getDistanceSqToEntity(this.vampire) < d0 * d0 && this.vampire.canEntityBeSeen(entitylivingbase)) {
				...
				if (this.ticks == 390) {
					...
					EntityFallingBlock falling = new EntityFallingBlock(worldObj, entitylivingbase.posX, entitylivingbase.posY + 5, entitylivingbase.posZ, HalloweenBlocks.pumpkinbomb.getDefaultState());
